...
export class AssetLowvalue extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dateType: 'month',
  ...
  getStateInfo(ifInit, ifPageChange) {
    ...
    this.getStateInfoTimeout = setTimeout(() => {
      ...
      let postUrl = ConfigureInfo.getQueryUrl(this.state.portType, this.state.dateType, 'AssetLowvalue');
