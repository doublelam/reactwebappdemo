...
class ClientManage_ extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      treeData: [],
  ...
  render() {
    ...
    const items = [
      {
        display: ifVague,
        dom: () => <Form.Item key="inputDate" label="添加客户时间：" className={publicStyles.paddingWith}>
      ...
      {
        display: true,
        dom: () => <Form.Item key="indistinctToName" label="客户名称：" className={publicStyles.paddingWith}>
  ...
  querySub() {
    this.props.form.validateFieldsAndScroll((err, val) => {
      ...
      this.refs.disTable.getTableInfo({
        url: 'bossClientInfo/getBossClientInfoList',
        params,
        excelUrl: '/tmsBossAdmin/bossClientInfo/getBossClientInfoListExcel',
...
export const ClientManage = Form.create()(ClientManage_);
